package com.test.xendit.helper.wait;
...
public class WaitHelper {
	...
	public void waitForFrameBeforeSwitching(WebElement element, long timeOutInSeconds, long pollingDurationInMiliSec) {
		log.info("waiting for the element " + element.toString() + "for time : " + timeOutInSeconds);
		Wait<WebDriver> fwait = getfluentWait(timeOutInSeconds, pollingDurationInMiliSec);
	...
	public WebElement waitForElementToBeClickable(By loc, long timeOutInSeconds,
												  long pollingDurationInMiliSec) {
		log.info("waiting for the element " + loc.toString() + "for time : " + timeOutInSeconds);
		Wait<WebDriver> fwait = getfluentWait(timeOutInSeconds, pollingDurationInMiliSec);
		return fwait.until(ExpectedConditions.elementToBeClickable(loc));
	}
